...
def iter_box(nx,ny,nz,spacing):
    ...
    boundary of a box. Will yield nx points/home/miladmalek/Dropbox/Chroma/multilens along the x axis, ny along the y
...
if __name__ == '__main__':
    ...
    #g = create_geometry_from_obj(chroma.demo.tiny(), update_bvh_cache=False)
    ...
    from ShortIO.root_short import RootWriter
    ...
    for ev in sim.simulate(photon_bomb(10000000,400,(0,0,0)),
                           keep_photons_beg=True,keep_photons_end=True,
                           run_daq=True,max_steps=100):
