...
if __name__ == '__main__':
    ...
    def create_event(location, sigma, amount, config, eventname):
        ...
        sim_events = gaussian_sphere(location, sigma, amount)
    ...
    full_detector_simulation(10.0, 1000000, 'config9', 'sim-config9-billion.root') 
        
    #full_detector_simulation(10.0, 1000000, 'config9', 'sim-config9-billion.root') 

    #full_detector_simulation(10.0, 1000000, 'config10', 'sim-config10-billion.root') 

    #create_event((0,0,0), 0.1, 100000, 'config2', 'event-config2-(0-0-0)-01-100000test.root')
    
    #create_event((3,3,3), 0.1, 100000, 'config9', 'event-config9-(3-3-3)-01-100000.root')
    
    #create_event((6,6,6), 0.1, 100000, 'config9', 'event-config9-(6-6-6)-01-100000.root')
